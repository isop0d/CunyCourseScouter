...
class Section(Base):
    ...
    days_times: Mapped[str] = mapped_column(String(100), default="")
    room: Mapped[str] = mapped_column(String(100), default="")
    instructor: Mapped[str] = mapped_column(String(100), default="")
    instruction_mode: Mapped[str] = mapped_column(String(60), default="")
    meeting_dates: Mapped[str] = mapped_column(String(60), default="")
